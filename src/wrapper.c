...
#endif
static THREAD_LOCAL char *cached_argv[8] = {NULL};
static THREAD_LOCAL char *cached_filename = NULL;
static THREAD_LOCAL size_t cached_filename_len = 0;
...
static THREAD_LOCAL char *rust_cached_argv[8] = {NULL};
static THREAD_LOCAL char *rust_cached_filename = NULL;
static THREAD_LOCAL size_t rust_cached_filename_len = 0;
static THREAD_LOCAL int rust_tls_initialized = 0;
