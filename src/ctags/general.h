...
*   INCLUDE FILES
*
*   Note: We include standard system headers here BEFORE defining __unused__
*   to avoid conflicts with glibc's __glibc_has_attribute(__unused__) macro
*   in <sys/cdefs.h> which expects __unused__ to not be defined as a macro.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>

/* Platform configuration - only modern Unix/Linux/macOS supported */
#if defined (HAVE_CONFIG_H)
# include <config.h>
#endif
/* Obsolete platform headers removed: e_amiga.h, e_djgpp.h, e_mac.h,
 * e_msoft.h, e_os2.h, e_qdos.h, e_riscos.h, e_vms.h */
 ...
 *  Note: We use __attribute__((__unused__)) instead of __attribute__((unused))
 *  to avoid conflicts with glibc's __glibc_has_attribute(__unused__) macro.
 */
