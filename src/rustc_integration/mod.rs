...
pub mod debug_log;
pub mod mir_harvester;

// Re-export for convenience
pub use hir_visitor::collect_from_hir;
pub use slicer_integration::analyze_crate_with_rustc_driver;
pub use virtual_slicer::{store_marked_items, is_item_marked, is_item_marked_by_def_id, is_safe_to_skip_by_def_id, build_marked_def_id_cache, build_codegen_caches, clear_marked_items, MarkedItemsInfo, should_codegen_item, is_safe_to_skip, skip_reason, init_call_graph, record_call_edge, batch_record_call_edges, take_call_graph, record_vtable_trait, has_vtable_constructions, vtable_trait_count, increment_stub_count, get_stub_count, init_stubbed_def_ids, record_stubbed_def_id, is_def_id_stubbed, stubbed_def_id_count, reset_compilation_state};
