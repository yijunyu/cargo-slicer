...
#![cfg_attr(feature = "rustc-driver", feature(box_patterns))]
...
// NOTE: Dep pruning was found ineffective — public items in lib crates can't be stubbed
// by `is_safe_to_skip()`, and most dep functions are public. See dep_analyzer.rs for details.
