...
*Part III of III. [Part I: The Waiting Game](part1.md) | [Part II: The Gap](part2.md)*

---

## Previously

In [Part I](part1.md), we saw that building Zed takes 17 minutes and no existing optimization really helps. In [Part II](part2.md), we discovered why: 37% of the compiler's work is spent on unreachable code — the "separate compilation gap."
...
- [Part I: The Waiting Game](part1.md)
- [Part II: The Gap](part2.md)
