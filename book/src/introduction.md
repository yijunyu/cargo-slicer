...
A cold release build of [Zed](https://zed.dev) takes 17 minutes. With cargo-slicer it takes under 12. A build of `zeroclaw` that takes 26 minutes drops to 98 seconds — a **15.8× speedup**. The `image` crate goes from 40 seconds to 1.4 seconds — **27.9×**.
...
| zeroclaw (4 crates) | 1,561 s | 99 s | **15.8×** |
