...
**Tracking issue**: [yijunyu/cargo-slicer#2](https://github.com/yijunyu/cargo-slicer/issues/2) (project-side; a rust-lang/rust PR is not committed — it stays a draft pending `#t-compiler` interest, see Zulip below)
