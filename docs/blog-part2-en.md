...
*Part II of III. [Part I: The Waiting Game](blog-part1-en.md) | [Part III: Closing the Gap](blog-part3-en.md)*

---

## Previously

In [Part I](blog-part1-en.md), we tried every known trick to speed up building Zed — parallel frontend, fast linker, caching, alternative backends. Nothing made a dent on that 17-minute clean release build. We ended with a question: what if the problem isn't how the compiler works, but what we're asking it to compile?
...
*To be continued in [Part III: Closing the Gap](blog-part3-en.md)...*

---

*This is Part II of a three-part series on cargo-slicer. [Part I](blog-part1-en.md) set up the problem. [Part III](blog-part3-en.md) provides the solution.*
